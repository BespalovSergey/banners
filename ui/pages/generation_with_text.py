...
from ui.ui_utils import IMAGE_GENERATORS, init_image_generator, find_remarks, navigation_menu, stop_other_generators
...
def main():
    ...
    generator_key = UiBannerGeneratorWithText.ui_state_name
